...
class UserData(models.Model):
    ...
    cover_img = models.ImageField(upload_to='User_cover_pic',default='User_cover_pic/flowers-background.jpg',blank=True,null=True)
...
class StaffTransactions(models.Model):
    ...
    bank_account = models.CharField(max_length=16,null=True,blank=True)
    contact = models.CharField(max_length=10,null=True,blank=True)
    ...
    UTI = models.CharField(max_length=100,null=True,blank=True,default='UTI')
# UserTransactions
class UserTransactions(models.Model):
    ...
    type = models.CharField(max_length=10)
    status = models.CharField(max_length=8,default='pending')
    # UTI = models.CharField(max_length=50,default='UTI')
#  DevTransactions 
