...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'risteyapp', 'static')
]
...
AUTH_USER_MODEL = 'risteyapp.User'
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'risteyapp', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
...
AWS_ACCESS_KEY_ID = "AKIAZWMUVXNMAMTHFEN3"
AWS_SECRET_ACCESS_KEY = "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"
