...
// import Menubar from "./Landing_Page/Menubar_Page/Menubar"

// import UserBalance from "./Home_Page/UserBalance";
    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          message.error('need to login')
        )} */}


          <Route path="/Staff_Panel" element={<Staff_Panel />} />
          <Route path="/Staff_Transactions" element={<Staff_Transactions />} />
          <Route path="/Staff_Withdrawals" element={<Staff_Withdrawals />} />
          ...
          <Route path="/User_Transaction_User" element={<User_Transaction_User />} />
          <Route path="/User_Withdrawal_User" element={<User_Withdrawal_User />} />
          <Route path="/User_Profile_User" element={<User_Profile_User />} />
