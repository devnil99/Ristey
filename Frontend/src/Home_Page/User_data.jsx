...
function User_data() {
  ...
  const user_get = async () => {
    ...
    const filter_female = response_UserDataGet.filter((i) => i.User_id === int_id);
    setData(filter_female);
        ...
        {data.map((i) => (
          ...
          /> */}
            ...
            >
              ...
              <a
                href={`https://wa.me/?text=${encodeURIComponent(`http://localhost:3000/User_data/${i.User_id}`)}`}
                target="_blank"
              ...
              {/* Facebook */}
              <a
                href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`http://localhost:3000/User_data/${i.User_id}`)}`}
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  fontSize: "28px",
              ...
              {/* Twitter */}
              <a
                href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`http://localhost:3000/User_data/${i.User_id}`)}&text=Check%20this%20out!`}
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  fontSize: "28px",
